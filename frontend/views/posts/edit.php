...
<h1>Edit <?= $this->model->post_id ?></h1>

<form action="<?= $this->home ?>/post/<?= $this->model->post_id ?>/edit" method="post">
<h3> Post </h3>
...
<form action="<?= $this->home ?>/post/<?= $this->model->post_id ?>/delete" method="post">
